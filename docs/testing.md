...
Denna teststrategi definierar testnivåer, ansvarsområden, regler och konventioner för *Kraftly Mina sidor*. Målet är att säkerställa hög tillförlitlighet i kritiska flöden med en sund balans mellan kvalitet och utvecklingstempo.
...
| :--- | :--- | :--- |
| **Enhet (*Unit*)** | `Vitest` | Testar isolerad affärslogik, hjälpfunktioner, stores och API-klient utan rendering av UI. |
...
| **E2E (*End-to-End*)** | `Cypress` | Simulerar kompletta användarresor och kritiska flöden genom hela applikationen. |
...
### Kodgranskning & PR (*Pull Requests*)
